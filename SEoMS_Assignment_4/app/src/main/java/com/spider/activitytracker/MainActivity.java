package com.spider.activitytracker;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, OnConnectionFailedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.addAction(ActivityRecognizedService.ACTION);
    ...
    public void onConnected(Bundle arg0) {
        if (client != null) {
            ...
            ActivityRecognition.ActivityRecognitionApi.requestActivityUpdates(client, 60000, pIntent);
        }
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.buttonSend) {
            ...
            if (text != null) {
                ...
                email.putExtra(android.content.Intent.EXTRA_SUBJECT, "[com.spider.activityrecognition] version " + version);
